...
function VersionRow({ version, versions }: { version: ObservatoryProjectVersionRow; versions: ObservatoryProjectVersionRow[] }) {
  ...
  const immutable = version.status === "released" || version.status === "archived";
